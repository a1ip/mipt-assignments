...
to setup
  ...
  set num-butterflies 50
  
  file-open "ElevationData.txt"
  while [not file-at-end?] [
    let next-X ((file-read - 10500) / 10)
    let next-Y ((file-read - 47500) / 10)
    let next-elevation file-read
    if next-X <= 150 and next-Y <= 150 [
...
to-report corridor-width
  let num-used-patches count patches with [ visited = true ]
...
to-report mean-elevation
  report mean [[elevation] of patch-here] of turtles
end
@#$#@#$#@
GRAPHICS-WINDOW
306
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean-elevation"
...
PENS
"default" 1.0 0 -16777216 true "" "histogram [[elevation] of patch-here] of turtles"

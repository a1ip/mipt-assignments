...
to go
  ifelse red-count = 0
    [ set red-extinction true ]
    [ set red-extinction false ]
  reproduce
  grim-reaper
  tick
end
...
@#$#@#$#@
<experiments>
  <experiment name="blue-fertility_red-extinction" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>red-count = 0</exitCondition>
    <metric>ticks</metric>
    <steppedValueSet variable="carrying-capacity" first="500" step="1000" last="1500"/>
    <enumeratedValueSet variable="red-fertility">
      <value value="2"/>
    </enumeratedValueSet>
    <steppedValueSet variable="blue-fertility" first="3" step="0.5" last="10"/>
  </experiment>
  <experiment name="risk-analysis" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>red-extinction</metric>
    <steppedValueSet variable="carrying-capacity" first="500" step="1000" last="1500"/>
    <enumeratedValueSet variable="red-fertility">
      <value value="2"/>
    </enumeratedValueSet>

...
to find-flockmates  ;; turtle procedure
  ...
  if count flockmates > max-neighbors [
    set flockmates min-n-of max-neighbors flockmates [ distance myself ]
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="sensitivity" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
